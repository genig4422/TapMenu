...
export default function MenuWithFixedButton() {
  ...
  const content = {
    Pizzas:[
      {price: "600L", name: "Margarita",  image: "/kearatares/margarita.jpg",display:"Tomato sauce, mozzarella, basil"},
      {price: "700L", name: "Ham",  image: "/kearatares/proshute.jpg"},
      {price: "700L", name: "Salami",  image: "/kearatares/proshut.jpg"},
      {price: "800L", name: "Diavola",  image: "/kearatares/diavola.jpg",display:"spicy sausage, olives, chili pepper"},
      {price: "1.000L", name: "Four Seasons",  image: "/kearatares/stinet.jpg",display:"ham, salami, artichokes, pepers"},
      {price: "1.000L", name: "Four Cheeses",  image: "/kearatares/diatherat.jpg",display:"mozzarella, ricotta, gorgonzola, parmesan"},
      {price: "1.000L", name: "Capricciosa",  image: "/kearatares/capricosa.jpg",display:"ham, mushrooms, artichokes, olives"},
      {price: "900L", name: "Tuna and Onion",  image: "/kearatares/ton.jpg"},
      {price: "1.100L", name: "Seafood",  image: "/kearatares/deti.jpg"},
      {price: "800L", name: "Ham and Potatoes",  image: "/kearatares/patate.jpg"},
      {price: "700L", name: "Mushrooms",  image: "/kearatares/kerpudh.jpg"},
      {price: "1.000L", name: "Parma",  image: "/kearatares/parma.jpg",display:"Parma ham, arugula, cherry tomatoes, parmesan cheese"},
      {price: "800L", name: "Romana",  image: "/kearatares/romana.jpg",display:"anchovies, olives, capers"},
      {price: "1.100L", name: "Bologna",  image: "/kearatares/bologna.jpg",display:"mortadella, buffalo mozzarella, pistachios"},
    ],
    ...
    Antipasti:[
        ...
        {price: "500L", name: "Veal with tuna fish sauce",  image: "/kearatares/vic.jpg",display:"roast beef with tuna fish sauce"},
    ...
    Meat: [
      ...
      {price: "1.700L", name: "Lamb Leg",  image: "/kearatares/kofshe.jpg"},
      ...
      {price: "2.500L", name: "Village Chicken In The Oven",  image: "/kearatares/ptaliatel.jpg",display:"me tagliatele"},
