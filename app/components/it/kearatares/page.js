...
export default function MenuWithFixedButton() {
  ...
  const content = {
    ...
    Sallata:[
        {price: "350L", name: "Sallate Fshati",  image: "/kearatares/fshati.jpg",display:"sallate jeshile,djath i bardhe,domate,kastravec,qepe"},
        {price: "600L", name: "Sallate Cezar",  image: "/kearatares/cesar.jpg",display:"gjoks pule,buke e thekur,domate,sallat jeshile,salce cezar"},
        {price: "500L", name: "Sallate Rukola",  image: "/kearatares/rukola.jpg",display:"rukola,djathe parmixhano,stika,domate qershi"},
        {price: "300L", name: "Sallate Domate Dhe Qepe",  image: "/kearatares/domate.jpg",},
    ],
    ...
    Pasta:[
        ...
        {price: "700L", name: "Tortelini Me Krem Gjalpi Dhe Proshute",  image: "/kearatares/krem.jpg"},
        ...
        {price: "800L", name: "Bucatini Ala Palermitana",  image: "/kearatares/sardele.jpg",display:"sardele,koper,stika,rrush i thate"},
