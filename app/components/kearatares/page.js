...
export default function MenuWithFixedButton() {
  ...
  const content = {
    Picat:[
      {price: "600L", name: "Margarita",  image: "/kearatares/margarita.jpg",display:"Salcë Domate, Mocarela, Borzilok"},
      {price: "700L", name: "Proshutë",  image: "/kearatares/proshute.jpg"},
      {price: "700L", name: "Sallam",  image: "/kearatares/proshut.jpg"},
      {price: "800L", name: "Diavola",  image: "/kearatares/diavola.jpg",display:"Sallam Pikant, Ullinj, Spec Djegës"},
      {price: "1.000L", name: "Katër Stinët",  image: "/kearatares/stinet.jpg",display:"Proshutë, Sallam, Angjinare, Speca"},
      {price: "1.000L", name: "Katër Djathëra",  image: "/kearatares/diatherat.jpg",display:"Mocarela, Rikota, Gorgonzola, Parmixhano"},
      {price: "1.000L", name: "Kapriçioza",  image: "/kearatares/capricosa.jpg",display:"Proshutë, Kerpudha, Angjinare, Ullinj"},
      {price: "900L", name: "Peshk Ton Dhe Qepë",  image: "/kearatares/ton.jpg"},
      {price: "1.100L", name: "Fruta Deti",  image: "/kearatares/deti.jpg"},
      {price: "800L", name: "Proshutë Dhe Patate",  image: "/kearatares/patate.jpg"},
      {price: "700L", name: "Kërpudha",  image: "/kearatares/kerpudh.jpg"},
      {price: "1.000L", name: "Parma",  image: "/kearatares/parma.jpg",display:"Proshutë Parma, Rukola, Domate Qershi, Djath Parmixhano"},
